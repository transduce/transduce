...
test: | node_modules
	$(NPM_BIN)/jshint array/*.js core/*.js transducers/*.js math/*.js async/*.js string/*.js test/*.js
...
$(BUILD).js: index.js core/*.js transducers/*.js array/*.js math/*.js string/*.js async/*.js | build
